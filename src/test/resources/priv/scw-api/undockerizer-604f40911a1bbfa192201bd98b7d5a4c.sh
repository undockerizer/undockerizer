...
echo WARN: The image could be generated with docker build secrets.
echo Docker build secret detected: /run/secrets/credenciales -> make sure you have the file in the detailed location
